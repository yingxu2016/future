...
void createInitialRuns(char *input_file) {
    ...
    if(memoryLimitInBytes <= 0) {
        cout << "Memory limitation must be a positive integer!" << endl;
        return;
    }
...
static void show_usage(string name) {
    ...
    cerr << "Usage: " << name << " --test" << endl << "Test mode will generate input file automatically.";
}
...
int main(int argc, char *argv[]) {
    ...
    if(argc == 2) {
        ...
        // first input is input file name
        // second input is memory limitation in bytes
        // third input is number of key value entries will be generated in the input file
        cout << "Test 1: memory limit with 0 and input entries 0" << endl;
        generateInput(input_file, 0, 0);
        externalSort(input_file, output_file);
        cout << "Test 2: memory limit with 1,000,000 bytes and input entries 0" << endl;
        generateInput(input_file, 1000000, 0);
        externalSort(input_file, output_file);
        cout << "Test 3: memory limit with 1,000,000 bytes and input entries 20,000" << endl;
        generateInput(input_file, 1000000, 20000);
        externalSort(input_file, output_file);
        cout << "Test 4: memory limit with 1,000,000 bytes and input entries 200,000" << endl;
        generateInput(input_file, 1000000, 200000);
        externalSort(input_file, output_file);
        cout << "Test 5: memory limit with 1,000,000 bytes and input entries 500,000" << endl;
        generateInput(input_file, 1000000, 500000);
        externalSort(input_file, output_file);
        cout << "Test 6: memory limit with 2,000,000 bytes and input entries 500,000" << endl;
        generateInput(input_file, 2000000, 500000);
        externalSort(input_file, output_file);
